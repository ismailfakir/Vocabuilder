 ...
 */
public class SaveFileBackgroundTask extends AsyncTask<Void, Void, Void> {
    Activity activity;
    ...
    public SaveFileBackgroundTask(Activity activity, ArrayList<DictionaryWord> words, String fileName) {
